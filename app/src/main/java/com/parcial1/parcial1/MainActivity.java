...
public class MainActivity extends AppCompatActivity {
    ...
    private List<lista_conctacto> list;
    ...
    private void initListener(){
        findViewById(R.id.add).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, activity_agregar_contacto.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 450) {
            if (resultCode == RESULT_OK) {
                list.add((lista_conctacto) data.getParcelableExtra("newPerson"));
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_ordenar_nom:
                Collections.sort(list, new Comparator<lista_conctacto>() {
                    public int compare(lista_conctacto obj1, lista_conctacto obj2) {
